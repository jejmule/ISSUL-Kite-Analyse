...
def plot_data() : 
    ...
    print('Gyro mean X :'+str(np.mean(kite.board_gyro[range,0])))
    print('Gyro mean Y :'+str(np.mean(kite.board_gyro[range,1])))
    print('Gyro mean Z :'+str(np.mean(kite.board_gyro[range,2])))
